...
Up/Down/Left/Right to move the highlighted green box
Space to solve the sudoku with backtrack
Enter to check if correct solution
Esc for quitting
1 to 9 for input number
Del to delete an input number
...
class Game:
    ...
    def __init__(self):
        """
        Class Game handles the game GUI
        :arg
        :return None
        """
